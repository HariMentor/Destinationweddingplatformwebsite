...
export default function WeddingPlanPageClient() {
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <Card className="p-12 text-center">
            ...
            <Button 
              ...
              onClick={() => router.push('/wedding-builder')}
            >
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          {/* Inspiration Moodboard Images */}
          {plan.inspirationImages && plan.inspirationImages.length > 0 && (
            <Card className="p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl mb-4 flex items-center gap-2" style={{ fontFamily: "Volkhov, serif" }}>
                <ImageIcon className="size-5 text-[#DF6951]" />
                Inspiration Moodboard
              </h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                {plan.inspirationImages.map((image, idx) => (
