            ...
            <>
              ...
              <div className="space-y-2 mt-6">
                <button
                  type="button"
                  onClick={() =>
                    setIsConciergeInfoExpanded(!isConciergeInfoExpanded)
                  }
                ...
                {isConciergeInfoExpanded && (
                  <div className="p-4 rounded-lg bg-white border border-gray-200 space-y-3 animate-in slide-in-from-top-2">
                    <p className="text-sm text-muted-foreground">
                      Our wedding concierge team acts as your personal wedding
                      planning assistant, coordinating with the venue and all
                      vendors to ensure your dream wedding comes to life.
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Professional advice on venue selection, packages,
                            and planning
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            We negotiate the best rates and packages on your
                            behalf
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              Coordinated communication with all vendors and
                              venue
                            </p>
                          </div>
                        </div>
