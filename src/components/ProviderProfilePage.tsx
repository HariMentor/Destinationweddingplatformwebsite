...
export function ProviderProfilePage({ providerId }: ProviderProfilePageProps) {
  ...
  const sortedVenues = [...filteredVenues].sort((a: any, b: any) => {
    ...
    if (sortBy === "price-low")
      return (
        parseInt(a.priceFrom.replace(/[^0-9]/g, "")) -
        parseInt(b.priceFrom.replace(/[^0-9]/g, ""))
      );
  ...
  const regions = Array.from(
    new Set(provider.venues.map((v: any) => v.region)),
  );
              ...
              <div className="flex-1 text-white">
                ...
                <div className="flex items-center gap-6 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {provider.weddingsHosted.toLocaleString()} Weddings
                    </span>
                  </div>
                </div>
              </div>
        ...
        <Tabs defaultValue="overview" className="space-y-8">
          ...
          <TabsContent value="overview" className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                ...
                <Card className="p-6">
                  ...
                  <div className="text-2xl">
                    {provider.weddingsHosted.toLocaleString()}+
                  </div>
                </Card>
              </div>
            ...
            >
              <Card
                className="p-8"
                style={{ borderTop: `4px solid ${provider.accentColor}` }}
              >
