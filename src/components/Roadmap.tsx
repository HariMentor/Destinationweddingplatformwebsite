      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our strategic plan to build the world's leading destination wedding platform
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {phases.map((phase, index) => {
            ...
            return (
              ...
              >
                <Card className={`p-6 h-full border-2 ${colors.border} hover:shadow-xl transition-all`}>
        ...
        >
          <div className="inline-flex items-center gap-4 bg-gradient-to-r from-rose-500 via-purple-500 to-blue-500 rounded-full p-1">
