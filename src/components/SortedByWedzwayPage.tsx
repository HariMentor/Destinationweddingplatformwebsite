...
const bangaloreVenues = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=1080&q=80",
...
const differentEvents = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1761114905078-163aa92141c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwcmVjZXB0aW9uJTIwaGFsbHxlbnwxfHx8fDE3NjkwODcwMDZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    icon: Heart,
    iconColor: "#DF6951",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1707593390358-cc4c779742c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbmdhZ2VtZW50JTIwY2VyZW1vbnl8ZW58MXx8fHwxNzY5MTg3ODMxfDA&ixlib=rb-4.1.0&q=80&w=1080",
    icon: Sparkles,
    iconColor: "#F1A501",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1650584997985-e713a869ee77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiaXJ0aGRheSUyMHBhcnR5JTIwY2VsZWJyYXRpb258ZW58MXx8fHwxNzY5MTE4NjEyfDA&ixlib=rb-4.1.0&q=80&w=1080",
    icon: Star,
    iconColor: "#DF6951",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1768851244529-39180171a168?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3Jwb3JhdGUlMjBldmVudCUyMHNldHVwfGVufDF8fHx8MTc2OTE3NzI1MXww&ixlib=rb-4.1.0&q=80&w=1080",
    icon: Building2,
    iconColor: "#02542D",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1722491634411-09ed1b34eacc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhbm5pdmVyc2FyeSUyMGNlbGVicmF0aW9ufGVufDF8fHx8MTc2OTE4NzgzMnww&ixlib=rb-4.1.0&q=80&w=1080",
    icon: Heart,
    iconColor: "#DF6951",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1761110787206-2cc164e4913c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBjZWxlYnJhdGlvbiUyMHZlbnVlfGVufDF8fHx8MTc2OTE4NzgzMHww&ixlib=rb-4.1.0&q=80&w=1080",
    icon: Music,
    iconColor: "#F1A501",
  },
];
...
const heroBackground =
  "https://images.unsplash.com/photo-1613067532651-7075a620c900?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwcmVjZXB0aW9uJTIwdmVudWV8ZW58MXx8fHwxNzY5MTcwNzU0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral";
...
const eventInspirations = [
  {
    id: 1,
    image:
      "https://images.unsplash.com/photo-1752857015591-c1b85c01c461?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwZGVjb3IlMjBlbGVnYW50fGVufDF8fHx8MTc2MDM3NzQyMXww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    id: 2,
    image:
      "https://images.unsplash.com/photo-1587635544862-0e0292bd8ab1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwZmxvd2VycyUyMHJvc2VzfGVufDF8fHx8MTc2MDM3NzQyMHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    id: 3,
    image:
      "https://images.unsplash.com/photo-1640794334523-b299f14d28db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwY2FrZSUyMGx1eHVyeXxlbnwxfHx8fDE3NjAyNzc0NzR8MA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    id: 4,
    image:
      "https://images.unsplash.com/photo-1677768061409-3d4fbd0250d1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwdGFibGUlMjBzZXR0aW5nfGVufDF8fHx8MTc2MDM3MDk2MHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    id: 5,
    image:
      "https://images.unsplash.com/photo-1723832348105-2e69f948135a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwcmVjZXB0aW9uJTIwbGlnaHRzfGVufDF8fHx8MTc2MDM3NzQxOHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    id: 6,
    image:
      "https://images.unsplash.com/photo-1641834916652-c7436fd6f99a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwY2VyZW1vbnklMjBhcmNofGVufDF8fHx8MTc2MDM3NTEwMnww&ixlib=rb-4.1.0&q=80&w=1080",
    title: "Ceremony Arch",
    category: "Ceremony",
  },
  {
    id: 7,
    image:
      "https://images.unsplash.com/photo-1578429031640-31345c8b8e34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwY2VudGVycGllY2UlMjBmbG9yYWx8ZW58MXx8fHwxNzYwMzc1MTAzfDA&ixlib=rb-4.1.0&q=80&w=1080",
    title: "Centerpieces",
    category: "Decor",
  },
  {
  ...
  },
  {
    id: 10,
    image:
      "https://images.unsplash.com/photo-1768851142314-c4ebf49ad45b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwYmFucXVldCUyMGhhbGx8ZW58MXx8fHwxNzY5MTg3OTk4fDA&ixlib=rb-4.1.0&q=80&w=1080",
    title: "Banquet Hall",
    category: "Venues",
  },
  {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      const payload = {
        ...
        isFlexible: true,
        message:
          formData.message || "Event planning request from Sorted by Wedzway",
        name: formData.name,
        phone: formData.phone,
        eventType: formData.eventType,
        budget: formData.budget
          ? parseFloat(formData.budget.split("-")[0]) * 100000
          : undefined,
      };
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="py-16 px-4 md:px-8 bg-gray-50/50">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our streamlined process ensures your event is perfectly planned in
              record time
            </p>
          </div>
            ...
            {[
              ...
              >
                <Card className="p-6 h-full bg-white border border-gray-100 hover:shadow-md transition-all">
                  ...
                  <div
                    className={`${item.iconBg} w-16 h-16 rounded-2xl flex items-center justify-center mb-4`}
                  >
                    <item.icon
      ...
      <section className="py-16 px-4 md:px-8 bg-[#fafafa]">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore beautiful event setups, décor ideas, and design
              inspiration to make your celebration unforgettable
            </p>
          </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-gradient-to-b from-white to-rose-50/30">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <p className="text-[#DF6951] font-semibold mb-2">
              Complete Package
            </p>
            <h2 className="text-4xl md:text-5xl mb-4 font-bold">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Full-service event planning with premium vendors and seamless
              execution
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                <Card className="p-6 h-full bg-white border border-gray-100 hover:shadow-md transition-all">
                  <div
                    className={`${service.iconBg} w-16 h-16 rounded-2xl flex items-center justify-center mb-4`}
                  >
                    <service.icon
                      className="size-8 stroke-[1.5]"
      ...
      <section
        id="request-form"
        className="py-16 px-4 md:px-8 bg-gradient-to-b from-white to-amber-50/30"
      >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Our team will reach out to you shortly within 2 hours
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-gradient-to-br from-[#02542D]/10 to-[#02542D]/5 p-6 rounded-2xl text-left">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Confirmation email and SMS sent to your contact
                          details
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-center gap-4 mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-sm font-medium ${enquiryStep === 1 ? "text-[#DF6951]" : "text-gray-600"}`}
                    >
                      Event Details
                    </span>
                  </div>
                  <div
                    className={`h-0.5 w-12 ${enquiryStep === 2 ? "bg-[#DF6951]" : "bg-gray-300"}`}
                  />
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
                    ...
                    <span
                      className={`text-sm font-medium ${enquiryStep === 2 ? "text-[#DF6951]" : "text-gray-500"}`}
                    >
                      Contact Info
                    </span>
                  </div>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Our team will contact you within 2 hours during
      ...
      <section className="py-16 px-4 md:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Real experiences from couples and event hosts who trusted Sorted
            ...
            {[
              {
                ...
                feedback:
                  "Absolutely incredible! We had just 3 days to plan our reception in Bangalore and Sorted made it happen flawlessly. The Taj West End venue was stunning, and every detail was perfect. Highly recommended!",
              ...
              },
              {
                ...
                feedback:
                  "The team at Sorted went above and beyond for my mother's milestone birthday. The décor was breathtaking, the food was exceptional, and everything ran smoothly. Worth every penny!",
              ...
              },
              {
                ...
                feedback:
                  "Professional, efficient, and creative. Sorted delivered an unforgettable corporate event that impressed all our stakeholders. The vendor coordination was seamless. Will definitely use again!",
              ...
              >
                <Card className="p-6 h-full hover:shadow-xl transition-all bg-white">
                  ...
                  <div className="inline-block bg-orange-50 px-3 py-1 rounded-full mb-4">
                    <span className="text-xs font-medium text-[#DF6951]">
