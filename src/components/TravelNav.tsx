...
import { Settings, Wand2, User, ChevronDown, Users, MapPin, Palette, Briefcase, Building2, Plane, FileText, Crown, Globe, Menu, X, ShoppingBag, Camera, Hotel, Mail, FileSpreadsheet, LogIn } from "lucide-react";
...
interface TravelNavProps {
  onNavigate?: (page: 'home' | 'landing' | 'venues' | 'destinations' | 'inspirations' | 'planners' | 'vendors' | 'tours' | 'visa-services' | 'builder' | 'expenses' | 'marketplace' | 'account' | 'concierge' | 'email-templates' | 'venue-brochure' | 'providers' | 'brand-guidelines' | 'blog' | 'venue-preview' | 'sorted' | 'auth' | 'register') => void;
  currentPage?: 'home' | 'landing' | 'venues' | 'destinations' | 'inspirations' | 'planners' | 'vendors' | 'tours' | 'visa-services' | 'builder' | 'expenses' | 'marketplace' | 'account' | 'concierge' | 'email-templates' | 'venue-brochure' | 'providers' | 'brand-guidelines' | 'blog' | 'venue-preview' | 'sorted' | 'auth' | 'register';
}
...
export function TravelNav({ onNavigate, currentPage = 'home' }: TravelNavProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-border">
      <div className={`mx-auto px-4 md:px-8 py-4 flex items-center ${isAccountPage ? 'justify-between' : 'justify-between'}`} style={{ maxWidth: isAccountPage ? 'none' : '1280px' }}>
        {/* Logo - Left aligned with sidebar on account page */}
        <div style={{ width: isAccountPage ? '256px' : 'auto', paddingLeft: isAccountPage ? '16px' : '0' }}>
          <button
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Sign in with OTP</div>
                    </div>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
